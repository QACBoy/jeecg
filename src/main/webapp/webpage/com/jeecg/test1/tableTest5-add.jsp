...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tableTest5Controller.do?doAdd" >
  ...
  <script src = "webpage/com/jeecg/test1/tableTest5.js"></script>		
