...
<div align="center" class="container loginBg">
    ...
    <div class="login">
    	<ul class="titleName">
        	<li class="english"> 东万晟 </li>
            <li class="chinese"> WMS </li>
        </ul>
        <ul class="loginInfo">
            <li>
	            <span>用户名：</span>
	            <input type="text"  class="userName" value="tester." name="userName" id="userName"/>
            </li>
            <li>
            	<span>密 &nbsp;码：</span>
            	<input type="password" name="password" class="password"  value="tester." name="password"  id="password"/>
            </li>
			<li>
            	<span>验证码：</span>
